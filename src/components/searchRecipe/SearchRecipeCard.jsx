...
export default function SearchRecipeCard({recipe}) {
  return recipe.map((val) => (
    <li
      key={val.recipeId}
      className="relative p-3 rounded-lg flex overflow-hidden size-[400px] md:size-[250px] lg:size-[400px] xl:size-[250px] 2xl:size-72 z-30 group **:transition-[filter, transform] **:duration-200 **:ease-in-out "
    >
      <Link
